        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Une collection de mes travaux explosant l'intersection entre le <span className="text-indigo-600 dark:text-indigo-400 font-semibold">web</span>, l'<span className="text-purple-600 dark:text-purple-400 font-semibold">IoT</span> et la <span className="text-pink-600 dark:text-pink-400 font-semibold">cybersécurité</span>.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayProjects.map((p, index) => (
              <motion.article
                key={p.id}
                className="group flex flex-col bg-white/70 dark:bg-gray-800/50 backdrop-blur-lg border border-white/20 dark:border-gray-700/50 rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-900/20 transition-all duration-500 transform hover:-translate-y-2"
