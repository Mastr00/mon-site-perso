          ...
          <div className="bg-cyber-100 dark:bg-cyber-800/50 border-b border-cyber-200 dark:border-cyber-800 p-8 text-cyber-950 dark:text-cyber-100 grid grid-cols-1 md:grid-cols-2 gap-8 print:bg-none print:text-black">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="text-center md:text-left">
                <h1 className="text-4xl font-bold font-mono tracking-tight mb-1 text-cyber-accent">
                  Mehdi Mamdouh
                </h1>
                <h2 className="text-lg font-bold text-cyber-950 dark:text-cyber-100 mb-4">
                  {t.cv.subtitle}
                </h2>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="p-2 bg-cyber-100 dark:bg-cyber-800 rounded-sm hover:text-cyber-accent transition-colors"
                    >
                      <Github size={16} className="text-cyber-500 hover:text-cyber-accent" />
                    </a>
                    <a
                      href="https://linkedin.com/in/mehdi-mamdouh"
                      target="_blank"
                      rel="noreferrer"
                      className="p-2 bg-cyber-100 dark:bg-cyber-800 rounded-sm hover:text-cyber-accent transition-colors"
                    >
            ...
            <div className="bg-cyber-50 dark:bg-cyber-900 border-r border-cyber-200 dark:border-cyber-800 text-cyber-950 dark:text-cyber-100 p-8 md:col-span-1 space-y-8 print:border-none print:bg-white print:text-black">
                ...
                <div className="space-y-3">
                  {t.cv.skillCategories.map((skill, idx) => (
                    <div key={idx} className="flex flex-col">
                      <span className="text-cyber-accent font-semibold text-[13px] mb-0.5">
                        {skill.category}
                      </span>
                      <span className="text-cyber-700 dark:text-cyber-300 text-[13px]">
                        {skill.items}
                      </span>
                    </div>
                  ))}
              ...
              >
                ...
                <ul className="space-y-1.5">
                  {t.cv.qualitiesList.map((quality, idx) => (
                    <li
                      key={idx}
                      className="flex items-center gap-2 text-cyber-700 dark:text-cyber-300 text-[13px]"
                    >
              ...
              >
                ...
                <ul className="space-y-2 text-[13px] text-cyber-700 dark:text-cyber-300 font-medium">
                  {t.cv.languagesList.map((l) => (
                    <li
                      key={l.name}
                      className="flex justify-between items-center pb-2 border-b border-cyber-200 dark:border-cyber-800/50 last:border-0 last:pb-0"
                    >
                      <span className="font-semibold text-cyber-950 dark:text-cyber-100">
                        {l.name}
                      </span>
              ...
              >
                <div>
                  ...
                  <div className="text-[13px] text-cyber-700 dark:text-cyber-300">
                    {t.cv.interestsList}
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-[13px] text-cyber-700 dark:text-cyber-300 mr-1">
                    {t.cv.licenseType}
                  </div>
                </div>
              </motion.section>
                ...
                <div className="border-l-2 border-cyber-200 dark:border-cyber-800 ml-2.5 pl-8 space-y-10 relative">
                  {t.cv.experiences.map((exp, i) => (
                    <div key={i} className="relative">
                      ...
                      <h3 className="text-[17px] font-bold text-cyber-950 dark:text-cyber-100">
                        {exp.role}
                      </h3>
                      <div className="text-cyber-accent text-sm font-semibold mt-0.5 mb-2">
                        {exp.company}{' '}
                        <span className="text-cyber-400 font-normal">| {exp.location}</span>
                      </div>
                      ...
                      <ul className="list-disc list-inside text-cyber-500 dark:text-cyber-300 text-[13px] space-y-1.5 leading-relaxed">
                        {exp.tasks.map((task, j) => (
                          <li key={j} className="marker:text-cyber-accent">
                            {task}
                          </li>
                        ))}
                      </ul>
                ...
                <div className="border-l-2 border-cyber-200 dark:border-cyber-800 ml-2.5 pl-8 space-y-8 relative">
                  {t.cv.educationList.map((edu, i) => (
                    <div key={i} className="relative">
                      ...
                      <p className="text-cyber-500 dark:text-cyber-300 text-[13px] mt-0.5 mb-2">
              ...
              >
                ...
                <div className="border-l-2 border-cyber-200 dark:border-cyber-800 ml-2.5 pl-8 space-y-8 relative">
                  {t.cv.technicalProjectsList.map((proj, i) => (
                    <div key={i} className="relative">
                      <span className="absolute -left-[37.5px] top-1.5 w-[10px] h-[10px] bg-cyber-accent rounded-full border-2 border-cyber-50 dark:border-cyber-900 box-content"></span>
                      <h3 className="text-[17px] font-bold text-cyber-950 dark:text-cyber-100 mb-2">
                        {proj.title}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {proj.tags.map((tag, j) => (
                          <span
                            key={j}
                            className="px-2 py-0.5 bg-cyber-100 dark:bg-cyber-800 text-cyber-500 border border-cyber-200 dark:border-cyber-700 rounded-[3px] text-[11px] font-semibold"
                          >
                            {tag}
                          </span>
                        ))}
