export const fr = {
  ...
  contact: {
    ...
    subtitle:
      "Ouvert aux opportunités professionnelles et aux collaborations techniques. N'hésitez pas à me contacter via le formulaire ci-dessous pour discuter de vos besoins.",
