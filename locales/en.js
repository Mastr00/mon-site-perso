export const en = {
    ...
    cv: {
        ...
        machinesList: ["CNC (Milling, calibration)", "3D Printing (FDM, SLA)", "Laser Cutting & Engraving"],
        qualitiesList: ["Autonomy & curiosity", "Team spirit", "Adaptability", "Communication", "Organizational skills"],
        skillCategories: [
        ...
        educationList: [
            { degree: "2nd Year — BSc Electronic Engineering", school: "Université Côte d'Azur", year: "2024 – 2025", location: "Nice" },
            { degree: "1st Year — BSc Science & Technology", school: "Université Côte d'Azur", year: "2023 – 2024", location: "Nice" },
        ],
        technicalProjectsList: [
            { title: "IoT Connected Weather Station", desc: "Autonomous weather station with GPS geolocation and time synchronization. Real-time environmental monitoring with OLED display.", tags: ["ESP32-S3", "C++", "GPS", "OLED", "IoT"] },
            { title: "TrailNav GPS Companion", desc: "Open-source alternative to commercial GPS computers (like Garmin Edge) for trail running and cycling, giving total control over data.", tags: ["ESP32-S3", "C++", "GPS", "6-Axis IMU", "TFT SPI", "SD"] },
            { title: "Fall Guard — Fall Detection", desc: "Smart safety system for isolated individuals. Fall detection through motion analysis and geolocated SOS alerts.", tags: ["C++", "Accelerometer", "GPS", "Safety"] },
            { title: "IA-Cam — Face Tracking Robot", desc: "Robot capable of detecting and tracking a face in real-time using computer vision. Servomotor control for smooth and autonomous tracking.", tags: ["ESP32-CAM", "Python", "OpenCV", "IoT"] },
            { title: "LSB Steganography on WAV Files", desc: "C program for hiding data within WAV audio files using Least Significant Bit (LSB) modification.", tags: ["C", "Signal Processing", "Audio"] },
        ],
        academicProjectsList: [
            { title: "4WD Autonomous Robot — Bluetooth Control", desc: "Design and assembly of an autonomous robot on a 4WD chassis. Implementation of remote Bluetooth control for navigation and driving.", tags: ["Arduino", "Bluetooth", "4WD", "C++"] },
        ],
    },
    // Footer
    footer: {
