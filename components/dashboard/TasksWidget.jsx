...
export default function TasksWidget() {
    ...
    return (
        <motion.div
            whileHover={{ y: -5 }}
            className="p-6 bg-cyber-50 dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 md:col-span-2 flex flex-col h-full bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900/50"
        >
            ...
            <div className="flex gap-2 mb-6">
                <div className="relative flex-grow">
                    <input
                        ...
                        className="w-full pl-4 pr-10 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all dark:text-cyber-100"
                    ...
                    {tasks.map(task => (
                        <motion.li
                            ...
                            className={`flex items-center p-3 rounded-xl border transition-all ${task.done
                                    ...
                                    : "bg-cyber-50 dark:bg-gray-800 border-gray-200 dark:border-gray-600 shadow-sm"
                                }`}
                        >
                            <button
                                onClick={() => toggleTask(task.id)}
                                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 transition-colors ${task.done
                                        ? "bg-green-500 border-green-500 text-cyber-950 dark:text-cyber-100"
