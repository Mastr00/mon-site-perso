...
export default function GithubWidget() {
  ...
  return (
    <motion.div
      ...
      className="p-6 bg-cyber-50 dark:bg-cyber-900 border border-cyber-200 dark:border-cyber-500/20 rounded-sm shadow-sm dark:shadow-[0_0_15px_rgba(56,189,248,0.1)] relative overflow-hidden group flex flex-col justify-between"
    >
      ...
      <div className="grid grid-cols-2 gap-3 mt-auto">
        <div className="bg-cyber-50 dark:bg-cyber-800 p-3 rounded-sm border border-cyber-100 dark:border-cyber-900 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[10px] text-cyber-500 uppercase font-bold tracking-wider">
              Repos
            </div>
          </div>
        </div>
