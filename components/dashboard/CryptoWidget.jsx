            ...
            {cryptoData.map((coin) => (
              <div key={coin.symbol} className="flex justify-between items-center group">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-8 h-8 rounded-full bg-cyber-100 dark:bg-cyber-900 flex items-center justify-center font-bold text-xs ${coin.color}`}
                  >
                    {coin.symbol}
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-xs flex items-center justify-end gap-1 font-medium ${coin.change >= 0 ? 'text-green-500' : 'text-red-500'}`}
                  >
